...
const UserSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'defaultReaderDirection': PropertySchema(
      id: 2,
      name: r'defaultReaderDirection',
      type: IsarType.long,
    ),
...
void _userSerialize(
  ...
  writer.writeString(offsets[1], object.defaultLanguage);
  writer.writeLong(offsets[2], object.defaultReaderDirection);
...
extension UserQueryFilter on QueryBuilder<User, User, QFilterCondition> {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> defaultLanguageIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> defaultLanguageIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> defaultLanguageEqualTo(
    String? value, {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> defaultLanguageGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> defaultLanguageLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> defaultLanguageBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<User, User, QAfterFilterCondition> defaultLanguageStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> defaultLanguageEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> defaultLanguageContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> defaultLanguageMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> defaultLanguageIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'defaultLanguage',
        value: '',
  ...
  QueryBuilder<User, User, QAfterFilterCondition> defaultLanguageIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'defaultLanguage',
        value: '',
  ...
  QueryBuilder<User, User, QAfterFilterCondition> defaultReaderDirectionEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'defaultReaderDirection',
        value: value,
      ));
    });
  }
  ...
  QueryBuilder<User, User, QAfterFilterCondition>
      defaultReaderDirectionGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition>
      defaultReaderDirectionLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> defaultReaderDirectionBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension UserQuerySortBy on QueryBuilder<User, User, QSortBy> {
  ...
  QueryBuilder<User, User, QAfterSortBy> sortByDefaultLanguage() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'defaultLanguage', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> sortByDefaultLanguageDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'defaultLanguage', Sort.desc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> sortByDefaultReaderDirection() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'defaultReaderDirection', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> sortByDefaultReaderDirectionDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'defaultReaderDirection', Sort.desc);
    });
  }
...
extension UserQuerySortThenBy on QueryBuilder<User, User, QSortThenBy> {
  ...
  QueryBuilder<User, User, QAfterSortBy> thenByDefaultLanguage() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'defaultLanguage', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> thenByDefaultLanguageDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'defaultLanguage', Sort.desc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> thenByDefaultReaderDirection() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'defaultReaderDirection', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> thenByDefaultReaderDirectionDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'defaultReaderDirection', Sort.desc);
    });
  }
...
extension UserQueryWhereDistinct on QueryBuilder<User, User, QDistinct> {
  ...
  QueryBuilder<User, User, QDistinct> distinctByDefaultLanguage(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QDistinct> distinctByDefaultReaderDirection() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'defaultReaderDirection');
    });
  }
...
extension UserQueryProperty on QueryBuilder<User, User, QQueryProperty> {
  ...
  QueryBuilder<User, String?, QQueryOperations> defaultLanguageProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'defaultLanguage');
    });
  }

  QueryBuilder<User, int, QQueryOperations> defaultReaderDirectionProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'defaultReaderDirection');
    });
  }
